...
#: Base canonica de la guia nacional.
PE_CORE_BASE = "https://www.gob.pe/minsa/RENHICE/fhir"

# --- Perfiles definidos en la guia nacional -------------------------------
...
# --- Sistemas de codigos nacionales ---------------------------------------
...
#: Codigo RENIPRESS del INSN San Borja. **A CONFIRMAR con la oficina de
#: informatica del instituto antes de cualquier envio real.**
INSNSB_RENIPRESS = "00006213"

#: Recursos para los que la guia nacional **no** define perfil todavia. Se
#: emiten en R4 base y se marcan como tales.
...
def device_resource(device_id: str, serial: str | None = None) -> dict[str, Any]:
    ...
    recurso: dict[str, Any] = {
        ...
        "identifier": [{"system": f"{PE_CORE_BASE}/NamingSystem/dispositivo",
                        "value": device_id}],
        "deviceName": [{"name": "Yawar Nan / KittyScope", "type": "model-name"}],
